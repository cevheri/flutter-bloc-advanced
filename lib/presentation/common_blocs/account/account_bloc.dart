...
class AccountBloc extends Bloc<AccountEvent, AccountState> {
  ...
  FutureOr<void> _onFetchAccount(
    ...
    try {
      ...
      _log.debug("END: getAccount bloc: _onLoad success: {}", [
        user.toString(),
      ]);
    } catch (e) {
  ...
  FutureOr<void> _onSubmit(
    ...
    try {
      ...
      _log.debug("END:onSubmitAccountSubmitEvent event success: {}", [
        user.toString(),
      ]);
    } catch (e) {
      emit(state.copyWith(status: AccountStatus.failure));
      _log.error("END:onSubmit AccountSubmitEvent event error: {}", [
        e.toString(),
      ]);
    }
  }
