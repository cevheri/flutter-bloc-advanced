...
class OfferRepository {
  ...
  Future<List<Offer>> getOffers({
    ...
    ConstOfferStationMaturity.statusList = [
      ConstOfferStationMaturity.calculatedOfferSelectedValue == true ? "statusId.in=12&" : "",
      ConstOfferStationMaturity.approvedOfferSelectedValue == true ? "statusId.in=3&" : "", // buna geri çekildi de eklenecek.
      ConstOfferStationMaturity.cancelledOfferSelectedValue == true ? "statusId.in=2&" : "",
      ConstOfferStationMaturity.rejectOfferSelectedValue == true ? "statusId.in=4&" : "",
      ConstOfferStationMaturity.confirmationOfferSelectedValue == true ? "statusId.in=9&" : "",
      ConstOfferStationMaturity.completedOfferSelectedValue == true ? "statusId.in=11&" : "",
    ];
    ConstOfferStationMaturity.urlString = ConstOfferStationMaturity.statusList[0].toString() +
    ...
    final offersHeaderRequest = await HttpUtils.getRequestHeader(
        "/offerings?createdDate.greaterThanOrEqual=${ConstOfferStationMaturity.startDate}&createdDate.lessThanOrEqual=${ConstOfferStationMaturity.endDate}&${ConstOfferStationMaturity.urlString}page=$startIndex&size=$limit&sort=id%2Cdesc");
  ...
  Future<List<Offer>> getOffersWithUser(User user, {required int startIndex, required int limit}) async {
    ConstOfferStationMaturity.statusList = [
      ConstOfferStationMaturity.calculatedOfferSelectedValue == true ? "statusId.in=12&" : "",
      ConstOfferStationMaturity.approvedOfferSelectedValue == true ? "statusId.in=3&" : "", // buna geri çekildi de eklenecek.
      ConstOfferStationMaturity.cancelledOfferSelectedValue == true ? "statusId.in=2&" : "",
  ...
  Future<Offer?> createOffer(Offer offer) async {
    ...
    return result == HttpUtils.successResult ? JsonMapper.deserialize<Offer>(saveRequest.body) : null;
  }
  ...
  Future<Offer?> updateOfferStatus(StatusChange statusChange) async {
    final saveRequest = await HttpUtils.postRequest<StatusChange>("/offerings/${statusChange.offeringId}/change-status", statusChange);
    String? result;
    ...
    return result == HttpUtils.successResult ? JsonMapper.deserialize<Offer>(saveRequest.body) : Offer();
  }
  ...
  Future<Offer?> updateOffer(Offer offer) async {
    final saveRequest = await HttpUtils.patchRequest<Offer>("/offerings/${offer.id}", offer);
    String? result;
