...
void main() {
  ...
  group('Api Exceptions', () {
    //FetchDataException
    test(
      'given FetchDataException when created then should return message',
      () {
        final exception = FetchDataException('Test Fetch Data Exception');
        expect(
          exception.toString(),
          equals('Error During Communication: Test Fetch Data Exception'),
        );
      },
    );
    //BadRequestException
    test(
      'given BadRequestException when created then should return message',
      () {
        final exception = BadRequestException('Test Bad Request');
        expect(
          exception.toString(),
          equals('Invalid Request: Test Bad Request'),
        );
      },
    );
    //UnauthorizedException
    test(
      'given UnauthorizedException when created then should return message',
      () {
        final exception = UnauthorizedException('Test access denied');
        expect(
          exception.toString(),
          equals('Unauthorized: Test access denied'),
        );
      },
    );
    //InvalidInputException
    test(
      'given InvalidInputException when created then should return message',
      () {
        final exception = InvalidInputException('Test invalid data');
        expect(
          exception.toString(),
          equals('Invalid Input: Test invalid data'),
        );
      },
    );
    //ApiBusinessException
    test(
      'given ApiBusinessException when created then should return message',
      () {
        final exception = ApiBusinessException('Test Business Exception');
        expect(
          exception.toString(),
          equals('Api Business Exception: Test Business Exception'),
        );
      },
    );
  });
  ...
  group('HttpUtils Tests', () {
    ...
    test(
      'given a new custom header when added then it should be in headers',
      () async {
    ...
    test(
      'given a UTF8 string when decoded then it should match original string',
      () {
    ...
    group('HTTP Requests', () {
      test(
        'given valid data when post request is made then should return success response',
        () async {
          ...
          final response = await HttpUtils.postRequest('/test', {
            'data': 'test',
          });
      ...
      test(
        'given valid data when post request is made then should return SocketException',
        () async {
          // ProfileConstants.isProduction = true;
          ProfileConstants.setEnvironment(Environment.prod);
          HttpUtils.setHttpClient(mockClient);
          ...
          await expectLater(
            ...
            throwsA(
              allOf([
                ...
                predicate(
                  (e) => e.toString().contains('Error During Communication'),
                ),
                predicate(
      ...
      test(
        'given valid data when post request is made then should return TimeoutException',
        () async {
          // ProfileConstants.isProduction = true;
          ProfileConstants.setEnvironment(Environment.prod);
          HttpUtils.setHttpClient(mockClient);
      ...
      test(
        'given valid data when get request is made then should return success 200',
        () async {
          // ProfileConstants.isProduction = true;
          ProfileConstants.setEnvironment(Environment.prod);
          HttpUtils.setHttpClient(mockClient);
      ...
      test(
        'given no internet connection when get request is made then should throw FetchDataException',
        () async {
          // ProfileConstants.isProduction = true;
          ProfileConstants.setEnvironment(Environment.prod);
          HttpUtils.setHttpClient(mockClient);
      ...
      test(
        'given no AccessToken when get request is made then should throw UnauthorizedException',
        () async {
          // ProfileConstants.isProduction = true;
          ProfileConstants.setEnvironment(Environment.prod);
          HttpUtils.setHttpClient(mockClient);
      ...
      test(
        'given no internet connection when get request is made then should throw SocketException',
        () async {
          // ProfileConstants.isProduction = true;
          ProfileConstants.setEnvironment(Environment.prod);
          HttpUtils.setHttpClient(mockClient);
      ...
      test(
        'given no internet connection when get request is made then should throw TimeoutException',
        () async {
          // ProfileConstants.isProduction = true;
          ProfileConstants.setEnvironment(Environment.prod);
          HttpUtils.setHttpClient(mockClient);
      ...
      test(
        'given valid data when put request is made then should return success 200',
        () async {
          // ProfileConstants.isProduction = true;
          ProfileConstants.setEnvironment(Environment.prod);
          HttpUtils.setHttpClient(mockClient);
          ...
          final response = await HttpUtils.putRequest('/test', {
            'data': 'test',
          });
          expect(response.statusCode, lessThan(300));
        },
      ...
      test(
        'given network timeout when put request is made then should throw SocketException',
        () async {
          // ProfileConstants.isProduction = true;
          ProfileConstants.setEnvironment(Environment.prod);
          HttpUtils.setHttpClient(mockClient);
      ...
      test(
        'given network timeout when put request is made then should throw TimeoutException',
        () async {
          // ProfileConstants.isProduction = true;
          ProfileConstants.setEnvironment(Environment.prod);
          HttpUtils.setHttpClient(mockClient);
      ...
      group('PATCH', () {
        test(
          'given valid data when patch request is made then should return success 200',
          () async {
            // ProfileConstants.isProduction = true;
            ProfileConstants.setEnvironment(Environment.prod);
            HttpUtils.setHttpClient(mockClient);
            ...
            final response = await HttpUtils.patchRequest('/test', {
              'data': 'test',
            });
            expect(response.statusCode, lessThan(300));
          },
        ...
        test(
          'given network timeout when patch request is made then should throw SocketException',
          () async {
            // ProfileConstants.isProduction = true;
            ProfileConstants.setEnvironment(Environment.prod);
            HttpUtils.setHttpClient(mockClient);
        ...
        test(
          'given network timeout when patch request is made then should throw TimeoutException',
          () async {
            // ProfileConstants.isProduction = true;
            ProfileConstants.setEnvironment(Environment.prod);
            HttpUtils.setHttpClient(mockClient);
      ...
      test(
        'given valid data when delete request is made then should return success 204',
        () async {
          // ProfileConstants.isProduction = true;
          ProfileConstants.setEnvironment(Environment.prod);
          HttpUtils.setHttpClient(mockClient);
      ...
      test(
        'given unauthorized user when delete request is made then should throw UnauthorizedException',
        () async {
          // ProfileConstants.isProduction = true;
          ProfileConstants.setEnvironment(Environment.prod);
          HttpUtils.setHttpClient(mockClient);
      ...
      test(
        'given unauthorized user when delete request is made then should throw SocketException',
        () async {
          // ProfileConstants.isProduction = true;
          ProfileConstants.setEnvironment(Environment.prod);
          HttpUtils.setHttpClient(mockClient);
      ...
      test(
        'given unauthorized user when delete request is made then should throw TimeoutException',
        () async {
          // ProfileConstants.isProduction = true;
          ProfileConstants.setEnvironment(Environment.prod);
          HttpUtils.setHttpClient(mockClient);
      ...
      group('Mock Requests', () {
        test(
          'given development environment when GET request is made then should return 200 status code',
          () async {
            // ProfileConstants.isProduction = true;
            ...
            await expectLater(
              ...
              throwsA(
                allOf([
                  ...
                  predicate((e) => e.toString().contains('Unauthorized')),
                  predicate(
                    (e) => e.toString().contains('Unauthorized Access'),
                  ),
                ]),
              ),
            );
        ...
        test(
          'given development environment when POST request is made then should return 200 status code',
          () async {
            // ProfileConstants.isProduction = true;
            ProfileConstants.setEnvironment(Environment.dev);
            await TestUtils().setupAuthentication();
        ...
        test(
          'given development environment when PUT request is made then should return 200 status code',
          () async {
            // ProfileConstants.isProduction = true;
            ProfileConstants.setEnvironment(Environment.dev);
            await TestUtils().setupAuthentication();
        ...
        test(
          'given development environment when DELETE request is made then should return 200 status code',
          () async {
            // ProfileConstants.isProduction = true;
            ProfileConstants.setEnvironment(Environment.dev);
            await TestUtils().setupAuthentication();
