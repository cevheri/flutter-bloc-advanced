...
class ChangePasswordErrorState extends ChangePasswordState {
  ...
  const ChangePasswordErrorState({required this.message})
    : super(status: ChangePasswordStatus.failure);
