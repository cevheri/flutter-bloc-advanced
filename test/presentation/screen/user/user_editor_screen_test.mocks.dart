...
import 'package:flutter_bloc_advance/features/users/data/repositories/user_repository.dart'
    as _i6;
import 'package:flutter_bloc_advance/shared/models/user_entity.dart' as _i7;
...
class MockUserBloc extends _i1.Mock implements _i2.UserBloc {
  ...
  @override
  void onDone(_i2.UserEvent? event, [Object? error, StackTrace? stackTrace]) =>
      super.noSuchMethod(
...
class MockUserRepository extends _i1.Mock implements _i6.UserRepository {
  ...
  @override
  _i4.Future<_i7.UserEntity?> retrieve(String? id) =>
      (super.noSuchMethod(
            Invocation.method(#retrieve, [id]),
            returnValue: _i4.Future<_i7.UserEntity?>.value(),
          )
          as _i4.Future<_i7.UserEntity?>);

  @override
  _i4.Future<_i7.UserEntity?> retrieveByLogin(String? login) =>
      (super.noSuchMethod(
  ...
  @override
  _i4.Future<_i7.UserEntity?> create(_i7.UserEntity? user) =>
      (super.noSuchMethod(
  ...
  @override
  _i4.Future<_i7.UserEntity?> update(_i7.UserEntity? user) =>
      (super.noSuchMethod(
  ...
  @override
  _i4.Future<List<_i7.UserEntity>> list({
    int? page = 0,
    int? size = 10,
    List<String>? sort = const ['id,desc'],
      ...
      (super.noSuchMethod(
            ...
            returnValue: _i4.Future<List<_i7.UserEntity>>.value(
              <_i7.UserEntity>[],
            ),
          )
  ...
  @override
  _i4.Future<List<_i7.UserEntity>> listByAuthority(
    int? page,
    int? size,
    String? authority,
  ) =>
  ...
  @override
  _i4.Future<List<_i7.UserEntity>> listByNameAndRole(
    int? page,
    int? size,
    String? name,
    String? authority,
