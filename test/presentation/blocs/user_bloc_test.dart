...
//       expect(const UserSearchEvent(0, 10, "ROLE_USER", "test"), const UserSearchEvent(0, 10, "ROLE_USER", "test"));
...
//     //         return bloc;
//     //       },
//     //       act: (bloc) => bloc.add(const UserSearchEvent(0, 10, "ROLE_USER", "")),
//     //       expect: () => [
...
//     //         return bloc;
//     //       },
//     //       act: (bloc) => bloc.add(const UserSearchEvent(0, 10, "ROLE_USER", "test")),
//     //       expect: () => [
//     //             const UserFindInitialState(),
//     //             UserSearchSuccessState(userList: [mockUserFullPayload])
//     //           ]);
