...
void main() {
  ...
  group("CityRepository Create success", () {
    test(
      "Given valid city when create then return city successfully",
      () async {
    ...
    test(
      "Given valid city without AccessToken when create then return city fail",
      () async {
        const entity = mockCityPayload;
        expect(
          () async => await CityRepository().create(entity),
    ...
    test("Given null city when create then return city fail", () async {
      expect(
        () async => await CityRepository().create(const City()),
        throwsA(isA<BadRequestException>()),
      );
    });
    test("Given null city when create then return city fail", () async {
      expect(
        () async => await CityRepository().create(const City(name: "")),
        throwsA(isA<BadRequestException>()),
      );
    });
  });
  ...
  group("CityRepository Get success", () {
    test(
      "Given valid when getCities then return cities successfully",
      () async {
        TestUtils().setupAuthentication();
    ...
    test(
      "Given valid without AccessToken when getCities then return cities fail",
      () async {
        expect(
          () async => await CityRepository().list(),
          throwsA(isA<UnauthorizedException>()),
        );
      },
    );
  ...
  group("CityRepository Get success", () {
    ...
    test(
      "Given valid id without AccessToken when getCity then return city fail",
      () async {
        expect(
          () async => await CityRepository().retrieve("1"),
          throwsA(isA<UnauthorizedException>()),
        );
      },
    );
    test("Given null id when getCity then return city fail", () async {
      expect(
        () async => await CityRepository().retrieve(""),
        throwsA(isA<BadRequestException>()),
      );
    });
  });
  ...
  group("CityRepository Delete success", () {
    ...
    test(
      "Given valid id without AccessToken when deleteCity then return fail",
      () async {
        expect(
          () async => await CityRepository().delete("1"),
          throwsA(isA<UnauthorizedException>()),
        );
      },
    );
    ...
    test("Given null id when deleteCity then return fail", () async {
      expect(
        () async => await CityRepository().delete(""),
        throwsA(isA<BadRequestException>()),
      );
    });
  });
