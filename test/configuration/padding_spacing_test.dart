...
void main() {
  group('Spacing', () {
    group('Constant values', () {
      test(
        'Given constant values When accessed Then should return correct values',
        () {
          // Given & When & Then
      ...
      test(
        'Given form width constants When accessed Then should return correct values',
        () {
          // Given & When & Then
    ...
    group('Height percentage calculations', () {
      testWidgets(
        'Given context When height percentage methods called Then should calculate correct values',
            ...
            MaterialApp(
              home: Builder(
                builder: (context) {
                  ...
                  expect(
                    Spacing.heightPercentage(context, 0.15),
                    height * 0.15,
                  );
                  return Container();
                },
      ...
      testWidgets(
        'Given invalid context When height percentage methods called Then should throw exception',
        (WidgetTester tester) async {
          // Given
          ...
          // When & Then
          expect(
            () => Spacing.heightPercentage10(invalidContext!),
            throwsA(isA<TypeError>()),
          );
          expect(
            () => Spacing.heightPercentage(invalidContext!, 0.5),
            throwsA(isA<TypeError>()),
          );
        },
      );
    ...
    group('Width percentage calculations', () {
      testWidgets(
        'Given context When width percentage methods called Then should calculate correct values',
        (WidgetTester tester) async {
          // Given
          await tester.pumpWidget(
            MaterialApp(
      ...
      testWidgets(
        'Given invalid context When width percentage methods called Then should throw exception',
        (WidgetTester tester) async {
          // Given
          BuildContext? invalidContext;
          ...
          // When & Then
          expect(
            () => Spacing.widthPercentage10(invalidContext!),
            throwsA(isA<TypeError>()),
          );
          expect(
            () => Spacing.widthPercentage(invalidContext!, 0.5),
            throwsA(isA<TypeError>()),
          );
        },
      );
