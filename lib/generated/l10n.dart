...
class S {
  ...
  String get error_auth_invalid_access_token {
    return Intl.message(
      'Invalid access token',
      name: 'error_auth_invalid_access_token',
      desc: '',
      args: [],
    );
  }
  ...
  String get error_auth_send_otp_failed {
    return Intl.message(
      'Could not send the OTP code',
      name: 'error_auth_send_otp_failed',
      desc: '',
      args: [],
    );
  }
  ...
  String get error_auth_otp_validation {
    return Intl.message(
      'OTP validation failed',
      name: 'error_auth_otp_validation',
      desc: '',
      args: [],
    );
  }
  ...
  String get error_auth_session_persist_failed {
    return Intl.message(
      'Could not save the session',
      name: 'error_auth_session_persist_failed',
      desc: '',
      args: [],
    );
  }
  ...
  String get error_user_cannot_delete_admin {
    return Intl.message(
      'Admin user cannot be deleted',
      name: 'error_user_cannot_delete_admin',
      desc: '',
      args: [],
    );
  }
  ...
  String get error_user_no_authorities {
    return Intl.message(
      'No authorities found',
      name: 'error_user_no_authorities',
      desc: '',
      args: [],
    );
  }
  ...
  String get user_extended_info_button {
    return Intl.message(
      'Extended Info',
      name: 'user_extended_info_button',
      desc: '',
      args: [],
    );
  }
  ...
  String user_extended_info_save_failed(String error) {
    return Intl.message(
      'Save failed: $error',
      name: 'user_extended_info_save_failed',
      desc: '',
      args: [error],
    );
  }
